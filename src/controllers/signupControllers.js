...
controller.signup = async (req, res) => {
    ...
    if(object === null){
        ...
        await userModels.create({ username : username, password : password, friends : [], usageTime : 0, signupDate : new Date(), loginDate : new Date() }) //Anadimos el usuario a la base de datos
        res.render('user', {
            option : 'Chats',
            username : username,
            friends : []
